...
Examples
--------
>>> rerank_passages_by_helpfulness(['p1', 'p2'], 'Where is the Eiffel Tower?', {'p1': 3}, graph)
[('p1', 0.86), ('p2', 0.42)]

>>> ask_llm_with_passages('Question?', ['p1'], graph, 'http://localhost:8000')  # doctest: +SKIP
{'raw_answer': '...', 'normalised_answer': '...'}
